...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Create  Team
            </h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="{{ URL::to('admin/team/store') }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <section class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" value="{{ old('position') }}" name="position" class="form-control title" placeholder="Position">
                                    @error('position')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
