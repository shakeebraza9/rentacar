...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">ALL TEAM LIST
            </h4>
        </div>
                    ...
                    <div class="col-sm-12">
                        <section class="card">
                            <header class="card-header" style="background-color: #6b0909; display: flex; justify-content: space-between; align-items: center;">
                                <h4 class="mb-0 text-white">All Team List</h4>
                                <a href="{{ route('team.create') }}" class="btn btn-light">Create New</a>
                            </header>
                        <div class="card-body">
        ...
        $(function () {
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                if (confirm('Are you sure you want to delete this FAQ?')) {
                    $.ajax({
                        url: "{{ url('admin/team/delete') }}/" + faqId,
                        type: 'DELETE',
