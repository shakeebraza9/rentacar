...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Article
            </h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="{{ route('artical.update', $article->id) }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <section class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" value="{{ old('title', $article->title) }}" name="title" class="form-control" placeholder="Title">
                                    @error('title')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="easymde-editor" name="description" class="form-control">{{ old('description', $article->description) }}</textarea>
                                    @error('description')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
