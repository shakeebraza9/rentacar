...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">EDIT  FAQ
            </h4>
        </div>
            ...
            <div class="card-body">
                <form id="faqEditForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" required>{{ $faq->description }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="type" name="type" required>
                            <option value="car" {{ $faq->type == 'car' ? 'selected' : '' }}>Car</option>
                            <option value="attraction" {{ $faq->type == 'attraction' ? 'selected' : '' }}>Attraction</option>
                        </select>
...
<script>
    $(document).ready(function () {
        $('#faqEditForm').submit(function (e) {
            ...
            $.ajax({
                url: "{{ url('admin/faq/update') }}/" + faqId,
                type: "POST",
                data: formData,
