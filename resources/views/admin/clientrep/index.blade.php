...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">ALL Report LIST
            </h4>
        </div>
                    ...
                    <div class="col-sm-12">
                        <section class="card">
                            <header class="card-header d-flex justify-content-between align-items-center" style="background-color: #6b0909">
                                <h4 class="mb-0 text-white">All Report List</h4>
                            </header>
...
@endsection
 @section('js')
      ...
      var application_table = $('.mydatatable').DataTable({
        ...
        searching: true,
        ajax: {
            url: "{{URL::to('admin/report/index')}}",
            type: "GET"
        },
        columns: [
            { data: "action", orderable: false, searchable: false }, // ✅ Fix action column
            { data: "name" },
            { data: "email" },
            { data: "subject" },
            { data: "message" },
