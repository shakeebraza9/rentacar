                        ...
                        <div class="wrap-search-form">
                            <div class="search-form">
                                ...
                                <div class="tab-content p-3" id="searchTabContent">
                                    <div class="tab-pane fade " id="car-rental" role="tabpanel"
                                        aria-labelledby="car-rental-tab">
                                        <form method="get" accept-charset="utf-8"
                                            action="https://www.langkawibook.my/customer/fleets">
                                    ...
                                    <div class="tab-pane fade " id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                                        <form method="get" accept-charset="utf-8"
                                            action="https://www.langkawibook.my/customer/hotels/list">
                                            <div class="row gx-1">
                                                <div class="col-md-4">
                    ...
                    <div class="accordion alt mt-4" id="accordionFaq">
                        <div class="accordion-item shadow-sm">
                            <h2 class="accordion-header" id="heading-17">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-17" aria-expanded="false" aria-controls="collapse-17">
                                    What are the Top 3 attractions to visit in Langkawi? </button>
                            </h2>
                            <div id="collapse-17" class="accordion-collapse collapse" aria-labelledby="heading-17"
                                data-bs-parent="#accordionFaq">
                                <div class="accordion-body">
                                    <p>The top 3 things to do in Langkawi are <a href="langkawi-skycab-cable-car.html"
                                            target="_blank">Langkawi SkyCab Cable Car</a>, <a
                                            href="langkawi-mangrove-tour.html" target="_blank">Langkawi Mangrove
                                            Tour</a>, and <a href="island-hopping-langkawi.html" target="_blank">Island
                                            Hopping Langkawi</a>.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item shadow-sm">
                            <h2 class="accordion-header" id="heading-18">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-18" aria-expanded="false" aria-controls="collapse-18">
                                    What are the Top 3 must-visit family-friendly attractions in Langkawi? </button>
                            </h2>
                            <div id="collapse-18" class="accordion-collapse collapse" aria-labelledby="heading-18"
                                data-bs-parent="#accordionFaq">
                                <div class="accordion-body">
                                    <p>The top 3 family-friendly attractions in Langkawi are <a
                                            href="underwater-world-langkawi.html" target="_blank">Underwater World
                                            Langkawi</a>, <a href="wildlife-park-langkawi.html" target="_blank">Wildlife
                                            Park Langkawi</a>, and <a href="crocodile-adventureland-langkawi.html"
                                            target="_blank">Crocodile Adventureland Langkawi</a>. Read more about the <a
                                            href="../blogs/10-best-family-attractions-in-langkawi-you-mustn-t-miss-out.html"
                                            target="_blank">family-friendly attractions in Langkawi</a> in our blog
                                        article!</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item shadow-sm">
                            <h2 class="accordion-header" id="heading-19">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-19" aria-expanded="false" aria-controls="collapse-19">
                                    What are the Top 3 outdoor adventure activities in Langkawi? </button>
                            </h2>
                        ...
                        <div class="accordion-item shadow-sm">
                            <h2 class="accordion-header" id="heading-20">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-20" aria-expanded="false" aria-controls="collapse-20">
                                    When is the best time to visit Langkawi? </button>
                            </h2>
                            <div id="collapse-20" class="accordion-collapse collapse" aria-labelledby="heading-20"
                                data-bs-parent="#accordionFaq">
                                <div class="accordion-body">
                                    <p>Langkawi enjoys warm and humid weather all year round, therefore you may visit
                                        Langkawi any time you prefer. We recommend checking out our <a
                                            href="../blogs/complete-langkawi-travel-guide-tips-from-locals.html"
                                            target="_blank">Complete Langkawi Travel Guide and Tips</a>.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item shadow-sm">
                            <h2 class="accordion-header" id="heading-21">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-21" aria-expanded="false" aria-controls="collapse-21">
                                    Does Langkawibook offer any discounts on attraction tickets? </button>
                            </h2>
                            <div id="collapse-21" class="accordion-collapse collapse" aria-labelledby="heading-21"
                                data-bs-parent="#accordionFaq">
                                <div class="accordion-body">
                                    Yes, we do offer special discounts on all attraction tickets. Book your tickets
                                    online today! </div>
                            </div>
                        </div>
                    </div>
